...
public class DriverTripsFragment extends Fragment {
    ...
    private DriverFragmentAdapter driverFragmentAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRef = firebaseDatabase.getReference("chatRooms/addTrip/drivers/"+user.getId());
        recyclerView = view.findViewById(R.id.driverTrips_recyclerView);
                ...
                for (DataSnapshot val: dataSnapshot.getChildren()){
                    ...
                    tripRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            Log.v("Trip","Data");
                            trips.add(trip);
                            driverFragmentAdapter = new DriverFragmentAdapter(getContext(),user,trips);
                            recyclerView.setAdapter(driverFragmentAdapter);
